...
- **L — transcript gate:** the machine's transcript is checked and fixed by the reviewer **before** any proposal is built on it (identification inherits transcript errors).
